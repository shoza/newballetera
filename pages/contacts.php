            ...
            <div class="contacts-info">
                ...
                <div class="social-links">
                    <a href="#" class="social-link" aria-label="Facebook">
                        <img src="<?= BASE_URL ?>/img/Facebook.png" alt="Facebook" width="16" height="16">
                    </a>
                    <a href="mailto:info@newballetera.com" class="social-link" aria-label="Email">
                        <img src="<?= BASE_URL ?>/img/Mail.png" alt="Email" width="16" height="16">
                    </a>
                    <a href="#" class="social-link" aria-label="Instagram">
                        <img src="<?= BASE_URL ?>/img/Instagram.png" alt="Instagram" width="16" height="16">
                    </a>
                </div>
            </div>
            ...
            <div class="contact-form">
                ...
                <?php else: ?>
                    ...
                    <form method="POST" action="<?= nav_url('/contacts') ?>">
                        ...
                        <div class="form-group">
                            <label>Message *</label>
                            <textarea name="message" required placeholder="Your message…" rows="6"><?= htmlspecialchars($_POST['message'] ?? '') ?></textarea>
                        </div>
